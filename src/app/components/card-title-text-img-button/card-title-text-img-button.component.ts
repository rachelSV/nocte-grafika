...
export class CardTitleTextImgButtonComponent {
  ...
  @Input() containerClass: string = 'glassmorphism p-6 sm:p-8 w-full my-10 rounded-lg shadow-lg';
  @Input() titleClass: string = 'text-3xl sm:text-4xl text-primary font-fraktur mb-4 uppercase';
  @Input() descriptionClass: string = 'text-primary text-xl sm:text-xl sm:text-base leading-relaxed mb-6';
  ...
  @Input() layoutClass: string = 'md:flex-row';
